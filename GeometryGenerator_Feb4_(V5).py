...
def cleanup_topology(geom, dx_val):
    ...
    new_geom = np.zeros_like(geom, dtype=int)
    new_geom[cleaned_solid] = 1
    ...
    final_geom = np.ones_like(geom, dtype=int) # Default solid
    final_geom[cleaned_fluid] = 0           # Set confirmed fluid
